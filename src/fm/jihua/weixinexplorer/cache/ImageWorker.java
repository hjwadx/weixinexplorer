...
package fm.jihua.weixinexplorer.cache;
...
public abstract class ImageWorker {
    ...
    private boolean mCornerBitmap = false;
    ...
    public void loadImage(Object data, ImageView imageView) {
        ...
        if (bitmap != null) {
        	...
        	if (mCornerBitmap) {
        		imageView.setImageBitmap(ImageHlp.getRoundedCornerBitmap(bitmap, 28));
        	} else {
            ...
            if (mCornerBitmap) {
    			...
    			if(bmp != null) {
    				imageView.setImageBitmap(ImageHlp.getRoundedCornerBitmap(bmp, 28));
    			} else {
    				Log.w("ImageWorker", "bmp is null");
    			}
            }		
    ...
    public void setImageCorner(boolean corner) {
        mCornerBitmap = corner;
        if (mCornerBitmap && mLoadingBitmap != null) {
        	mLoadingBitmap = ImageHlp.getRoundedCornerBitmapAuto(mLoadingBitmap);
        }
    }
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Object... params) {
            ...
            if (mCornerBitmap) {
    			if(bitmap != null) {
    				bitmap = ImageHlp.getRoundedCornerBitmapAuto(bitmap);
    			} else {
    				Log.w("ImageWorker", "bmp is null");
    			}
            }	
